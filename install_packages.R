...
# CRAN
list.of.packages <- c("rJava","shiny","shinyjs","igraph","DT","miniUI","rhandsontable","snowfall","shinyBS","shinythemes","shinyFiles","dplyr","tibble","ggplot2","visNetwork","shinyalert","shinyWidgets","lpSolve","sortable","colorspace","devtools","BiocManager")
